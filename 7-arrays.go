...
func main() {
	...
	// type of elements and length are both part of arry's type. By
	// default an array is zero-valued, wich for ints means 0s.
	var a [5]int
	fmt.Println("emp:", a)
	...
	// You can also have the compiler count the number of elements
	// for you with ... syntax
	b = [...]int{1, 2, 3, 4, 5}
	fmt.Println("dcl:", b)

	// If you specify the index with :, the elemnts in between will be
	// zeroed.
	b = [...]int{100, 3: 400, 500}
	fmt.Println("idx:", b)
	...
	// You can create and initialize multi-dimensional arrays at once
	// too.
	twoD = [2][3]int{
		{1, 2, 3},
		{1, 2, 3},
